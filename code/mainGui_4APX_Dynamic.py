...
clusterCenters = run.generateClustersSimple(config ={'mis_algorithm':'networkx_random_choose_20_iter_best' }) # Generate clusters. Each cluster center itself is a tra1ectory.
