...
*DYNAMIC $r$-GATHER:*      If the $(x,y)$ co-ordinates of the data-set are live and moving, how do we update 
$OPT$ efficiently? 
...
#+BEGIN_SRC python :noweb-ref MAKE_CLUSTER_CENTERS :exports none
