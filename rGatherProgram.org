...
To generate neighbor relations for the dynamic-case, since I don't have a good neighbor search routine for arbitrary metric spaces, here is a little code, 
to pre-compute eevrything. 

#+BEGIN_SRC python :tangle code/DynamicInput/getNeighbors.py :exports yes
